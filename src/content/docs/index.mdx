...
description: Get started with CodeSnippetUI - The Ultimate Component Library
icon: Rocket
color: purple
---
...
All components are powered by [Tailwind CSS v4](https://tailwindcss.com) and use the handy `cn` utility function. Install with:
