...
export const SwipeCheckbox = React.forwardRef<HTMLInputElement, AnimatedCheckboxProps>(
  (
    {
      className,
      checkboxClassName,
      ...
      <div className={cn("flex items-start space-x-2", className)}>
        <div className="relative flex h-6 items-center">
          ...
          <motion.div
            ...
            className={cn(
              "flex h-5 w-5 items-center justify-center rounded border overflow-hidden",
...
SwipeCheckbox.displayName = "SwipeCheckbox"
